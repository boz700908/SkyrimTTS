...
- Uses [CommonLibSSE-NG](https://github.com/alandtse/CommonLibVR/tree/ng) (Address Library for SKSE Plugins) to provide version independency from SKSE to plugins.
