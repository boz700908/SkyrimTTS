class ModCategoryList extends MovieClip
{
   ...
   {
      super();
      trace("ModCategoryList::ModCategoryList");
   ...
   {
      trace("ModCategoryList::onDataObjectChange");
      var _loc2_ = 0;
   ...
   {
      trace("ModCategoryList::RefreshEntryData");
      this._MaxSelectedIndex = 1.7976931348623157e+308;
      var _loc2_ = 0;
   ...
   {
      trace("ModCategoryList::onEntryRollover");
   ...
   {
      trace("ModCategoryList::BubbleEvent " + event.type);
