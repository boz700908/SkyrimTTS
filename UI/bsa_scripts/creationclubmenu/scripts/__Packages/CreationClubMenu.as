class CreationClubMenu extends MovieClip
{
   ...
   {
      trace("CreationClubMenu::SetPlatform: aiPlatform " + aiPlatform.toString() + ", aSwapPS3 " + abPS3Switch.toString());
      this.iPlatform = aiPlatform;
      this.PS3Switch = abPS3Switch;
      if(this.iPlatform == Shared.ButtonChange.PLATFORM_PS3)
      {
         if(this.PS3Switch)
         {
            trace("CreationClubMenu::SetPlatform swapping X and O for Playstation");
            CreationClubMenu.PURCHASE_MOD.PS3Art = "CCPS3_B";
            CreationClubMenu.BUTTON_UPDATE_CREATION.PS3Art = "CCPS3_B";
            CreationClubMenu.BUTTON_DOWNLOAD_CREATION.PS3Art = "CCPS3_B";
            CreationClubMenu.DETAILS.PS3Art = "CCPS3_B";
            CreationClubMenu.CANCEL.PS3Art = "CCPS3_A";
         }
      }
      if(this._codeObjInitialized)
      {
