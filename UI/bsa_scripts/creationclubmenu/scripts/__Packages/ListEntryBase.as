class ListEntryBase extends MovieClip
{
   ...
   {
      super();
      trace("ListEntryBase::ListEntryBase");
   ...
   {
      trace("ListEntryBase::onThumbnailLoadComplete");
   ...
   {
      trace("ListEntryBase::UnloadThumbnail");
      if(this._DataObj != null)
      {
   ...
   {
      trace("ListEntryBase::redrawUIComponent");
      var _loc3_;
      var _loc2_;
      var _loc4_;
      if(this._DataObj == null)
      ...
      else
      {
         ...
         if((this._DataObj.installed == true || this._DataObj.installQueued == true) && this._DataObj.uninstallQueued != true)
         {
            ...
            trace("ListEntryBase::redrawUIComponent colorTrans = " + _loc4_);
