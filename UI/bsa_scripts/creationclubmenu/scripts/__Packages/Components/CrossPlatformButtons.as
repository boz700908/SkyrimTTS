class Components.CrossPlatformButtons extends gfx.controls.Button
{
   ...
   function CrossPlatformButtons()
   {
      ...
      trace("CrossPlatformButtons::CrossPlatformButtons " + this.label);
   }
   function onLoad()
   {
      super.onLoad();
      ...
      trace("CrossPlatformButtons::onLoad " + this.label);
   }
   function SetPlatform(aiPlatform, aSwapPS3)
   {
      trace("CrossPlatformButtons::SetPlatform " + this.label + " -> " + aiPlatform.toString() + ", PS3Swap = " + aSwapPS3.toString());
   ...
   function RefreshArt()
   {
      trace("CrossPlatformButtons::RefreshArt " + this.label + " -> " + this.CurrentPlatform.toString());
   ...
   {
      trace("CrossPlatformButtons::SetArt  " + this.label + " -> " + aPlatformArt.PCArt);
