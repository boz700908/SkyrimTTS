class MagicMenu extends ItemMenu
{
   ...
   function PositionElements()
   {
      ...
      this.ItemsListInputCatcher._x -= Stage.safeRect.x;
   ...
   function UpdateButtonText()
   {
      ...
      {
         _loc3_ = (this.InventoryLists_mc.ItemsList.selectedEntry.filterFlag & this.InventoryLists_mc.CategoriesList.entryList[0].flag) == 0 ? "$Favorite" : "$Unfavorite";
         _loc2_ = this.ItemCard_mc.itemInfo.showUnlocked != true ? "" : "$Unlock";
